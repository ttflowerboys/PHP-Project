	...
	<div id="topbar">
		<div id="topmenu">
			...
			<dl>
				...
				<dd>
					<div>、
						<li class="first"><a href="' . BURL('user/add') . '">添加用户</a></li>
						<li class="last"><a href="' . BURL('user') . '">用户列表</a></li>

						<li class="first"><a href="' . BURL('users/add') . '">添加管理员</a></li>
						<li class="last"><a href="' . BURL('users') . '">管理员列表</a></li>
					</div>
				</dd>
			</dl>
			<dl>
				<dt><a href="' . BURL('news') . '">营销区域</a></dt>
				<dd>
					<div>
						
						<li class=""><a href="' . BURL('areas') . '">区域设置</a></li>
...
<div id="sidebar">
	...
	<ul>
		...
		<li class="has-sub">
		   ...
		   <ul class="sub">
		   						<li ><a href="' . BURL('user/add') . '">添加用户</a></li>
						<li><a href="' . BURL('user') . '">用户列表</a></li>
		...
		<li class="has-sub">
		   <a href="#">
		   <i class="i-others"></i> 
		   <span class="title">营销区域</span>
		   <span class="arrow"></span>
		   </a>
		   <ul class="sub">

			  <li><a href="' . BURL('areas') . '">区域设置</a></li>
