...
<div class="w">
    <form class="ajaxForm form-horizontal" action="<?php PURL('edit/editDo'); ?>" enctype="multipart/form-data" method="post">

        <div class="spread">
            <h2 class="tit"><i class="icon-feedback"></i>LIAN JIA 公开审计问卷</h2>
		<input type="hidden" value="<?php echo $this->_tpl_vars['record']['id']; ?>" name="id">
			<div class="clearfix form-horizontal">
				<div class="w-md-3_5p">
					<div class="form-items"><span class="input-group-addon">店面编码</span><input type="text" name="dpno" class="input-text" value="<?php echo $this->_tpl_vars['record']['dp_no']; ?>" required></div>
					<div class="form-items"><span class="input-group-addon">营销大区</span><?php echo $this->_tpl_vars['navs']; ?></div>
					<div class="form-items"><span class="input-group-addon">业务区域</span><select name="careas" id="careas" class="input-text"  required><option value="<?php echo $this->_tpl_vars['record']['qy_catid']; ?>"><?php echo areaType($this->_tpl_vars['record']['qy_catid']); ?></option></select></div>					
					<div class="form-items"><span class="input-group-addon">店面名称</span><input type="text" name="dpname" class="input-text" value="<?php echo $this->_tpl_vars['record']['name']; ?>" required></div>
					<div class="form-items"><span class="input-group-addon">店面地址</span><input type="text" name="address" class="input-text" value="<?php echo $this->_tpl_vars['record']['address']; ?>" required title="<?php echo $this->_tpl_vars['record']['address']; ?>"></div>
				</div>
				<div class="w-md-3_5p">					
					<div class="form-items"><span class="input-group-addon">走访日期</span><input type="text" name="zftime" class="input-text input-text-time"  value="<?php echo DisplayDate($this->_tpl_vars['record']['zftime']); ?>" onclick="laydate()" required></div>
					<div class="form-items"><span class="input-group-addon">走访时间</span><input class="input-text" name="zfintime" value="<?php echo $this->_tpl_vars['record']['zfintime']; ?>" style="width:41%" required> ~ <input class="input-text" name="zfouttime" value="<?php echo $this->_tpl_vars['record']['zfouttime']; ?>" style="width:41%" required></div>
					<div class="form-items">
	            		<span class="input-group-addon">店内经纪人数量</span>
	            		<input name="check_num" type="text" value="<?php echo $this->_tpl_vars['record']['check_num']; ?>" class="input-text" style="width:73%">
	            	</div>
	            	<div class="form-items">
	            		<span class="input-group-addon">审核经纪人数量</span>
	            		<input name="jj_num" type="text" value="<?php echo $this->_tpl_vars['record']['jj_num']; ?>" class="input-text" style="width:73%">
	            	</div>
	            	<div class="form-items">
	            		<span class="input-group-addon">店内顾客人数量</span>
	            		<input name="gk_num" type="text" value="<?php echo $this->_tpl_vars['record']['gk_num']; ?>" class="input-text" style="width:73%">
	            	</div>
				...
				<div class="w-md-30p">
					<div class="form-items">
		            	...
		            	<input name="manfen" type="text" value="<?php echo $this->_tpl_vars['record']['manfen']; ?>" class="input-text">
		            </div>
		            <div class="form-items">
		            	<span class="input-group-addon">女经纪人得分</span>
		            	<input name="womanfen" type="text" value="<?php echo $this->_tpl_vars['record']['womanfen']; ?>" class="input-text">
		            </div>		            
		            <div class="form-items">
		            	<span class="input-group-addon">店面环境得分 </span>
		            	<input name="storefen" type="text" value="<?php echo $this->_tpl_vars['record']['storefen']; ?>" class="input-text">
		            </div>
		            <div class="form-items">
		            	<span class="input-group-addon">店铺总体得分</span>
		            	<input name="totalfen" type="text" value="<?php echo $this->_tpl_vars['record']['totalfen']; ?>" class="input-text">
		            </div>
		            <div class="form-items">
		            	<span class="input-group-addon">审计员姓名：</span>
		            	<input name="zfuser" type="text" value="<?php echo $this->_tpl_vars['record']['zfuser']; ?>" class="input-text" required>
		            </div>
			...
			<hr class="hr">
				    <div class="clearfix">
				        <div class="w-md-3">
				    		<div class="detailsItems"><a href="<?php PURL('edit?id=' . $this->_tpl_vars['record']['id']); ?>">
				    			<i class="icon-store"></i>
				    			<div class="info">店面环境得分：<b class="t-red"><?php echo $this->_tpl_vars['record']['storefen']; ?></b> 分<br>查看更多 ></div></a>
				    		</div>
				    	</div>
				    	<div class="w-md-3">
				    		<div class="detailsItems"><a href="<?php PURL('from2?id=' . $this->_tpl_vars['record']['id']); ?>">
				    			<i class="icon-man"></i>
    ...
    <div class="upBox">
		...
		<div class="clearfix">
		  	<div class="w-md-15">
		  		<div class="FromHd"><span>店铺评价<strong class="count">总得分：<b class="t-red J_CurPirce"><?php echo $this->_tpl_vars['record']['storefen']; ?></b></strong></span></div>
		  	</div>
		  	<input type="hidden" name="score" value="<?php echo $this->_tpl_vars['record']['storefen']; ?>" class="J_score">
		  	<div class="w-md-8p">
		  	  <textarea name="dp_desc" class="textarea input-textarea" placeholder="请描述该店面给您的第一印象如何？"><?php echo $this->_tpl_vars['dpinfoDesc']; ?></textarea>
