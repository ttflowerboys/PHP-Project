...
<div class="spread2">
    <div class="upBox">
		...
		<div class="clearfix">
		  	<div class="w-md-15">
		  		<div class="FromHd"><span>店铺评价<strong class="count">总得分：<b class="t-red J_CurPirce"  readonly><?php echo $this->_tpl_vars['record']['storefen']; ?></b></strong></span></div>
		  	</div>
		  	<div class="w-md-8p">
		  	  <textarea name="dp_desc" class="textarea input-textarea" placeholder="请描述该店面给您的第一印象如何？" readonly><?php echo $this->_tpl_vars['dpinfoDesc']; ?></textarea>
