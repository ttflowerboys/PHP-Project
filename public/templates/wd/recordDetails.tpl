...
<div class="spread">
    ...
    <div class="clearfix">
        <div class="w-md-3">
    		<div class="detailsItems"><a href="{PURL('record?id=' . $record.id.'&show=1')}" target="_blank">
    			<i class="icon-store"></i>
    			<div class="info">店面环境得分：<b class="t-red">{$record.storefen}</b> 分<br>查看更多 ></div></a>
    		</div>
    	</div>
    	<div class="w-md-3">
    		<div class="detailsItems"><a href="{PURL('record?id=' . $record.id.'&show=2')}" target="_blank">
    			<i class="icon-man"></i>
