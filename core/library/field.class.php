...
class field
{
    ...
    public static function input($name, $content = '', $setting = '', $placeholder = '')
    {
        //$style = isset($setting['size']) ? " style='width:" . ($setting['size'] ? $setting['size'] : 150) . "px;'" : '';
        return '<input type="text" id="V_'. $name .'" value="' . $content . '" class="ipt-text" name="data[' . $name . ']" placeholder="' . $placeholder . '">';
    }
    ...
    public static function select($name, $content = '', $setting = '')
    {
        ...
        $str = "<select class='ipt-select' id='" . $name . "' name='data[" . $name . "]'>";
        foreach ($select as $t) {
