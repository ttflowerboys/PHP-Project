		...
		<div class="col-tab">
			...
			<div class="contentList pad-10 hidden" id="div_3" style="display: none;" >
				...
				<tr>
					...
					<td><textarea name="data[member_level]" rows="7" cols="55" class="text"><?php echo $data['member_level']; ?></textarea><br/><div class="onShow">格式为 数字|名称 </div></td>
				</tr>
				<tr>
					<th width="100">班级类型：</th>
					<td><textarea name="data[member_class]" rows="7" cols="55" class="text"><?php echo $data['member_class']; ?></textarea><br/><div class="onShow">格式为 数字|名称 </div></td>
				</tr>
				<!-- <tr>
					<th >QQ登录： </th>
